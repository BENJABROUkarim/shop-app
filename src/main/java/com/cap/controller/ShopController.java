...
import com.cap.service.ShopService;
import com.cap.validation.ShopValidator;
...
public class ShopController {
	...
	public ModelAndView createNewShop(@ModelAttribute @Valid Shop shop, BindingResult result,
	...
	public ModelAndView editShop(@ModelAttribute @Valid Shop shop, BindingResult result, @PathVariable Integer id,
			final RedirectAttributes redirectAttributes) throws com.cap.exception.ShopNotFound {
